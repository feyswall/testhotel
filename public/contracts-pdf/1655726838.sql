...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=926529981ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_solution&table=sales">`hotel_solution`.`sales`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_solution&table=item_sale">`hotel_solution`.`item_sale`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_solution&table=customers">`hotel_solution`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_solution&table=items">`hotel_solution`.`items`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="653b6427432d4f645e54693736384e79">
