...
@section('content')
    <main class="content">
        <div class="container-fluid p-0">
            <a href="/suppliers" class="btn btn-primary float-end mt-n1"><i class="fa fa-arrow-left"></i> View Contract</a>
                    ...
                    <form method="POST" action="{{ route('contract.store') }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <Select name="category" value="{{ old('category') }}" class="form-select" id="category"
                                    placeholder="">
