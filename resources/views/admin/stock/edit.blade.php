                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <p></p>
                                <h3 class="lead">Available item(s): {{ $stock->items->count() }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="tab tab-vertical">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#vertical-icon-tab-1" data-bs-toggle="tab"
                                        role="tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="vertical-icon-tab-1" role="tabpanel">
                                    <h4 class="tab-title mb-3">Stock Items</h4>
                                    ...
                                    <img src="{{ asset('assets/img/avatars/avatar-5.jpg') }}" width="35" height="35" class="rounded m-0" alt="image">
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('admin.stock.items.trace', [$stock->id, $item->id]) }}">Manage</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header border-bottom pb-2">
                                                ...
                                                <div class="card-actions float-end mx-3">
                                                    <div class="row">
                                                        <div class="col col-md-12">
                                                            <input v-model="item_search" @keyup.enter="search()"
                                                ...
                                                <div class="card-actions float-end">
                                                    <a href="#" v-if="results.length > 0" v-on:click="closeTable()"
                                                        class="btn btn-danger text-white float-end">
                                                        <i class="la la-close"></i>
                                                    </a>
                                                </div>
                                                <h5 class="card-title">Add Stock Items</h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="mx-3">
                                                    @if ($errors->any())
                                                ...
                                                <table v-if="(results.length == 0 && items.length == 0)"
                                                ...
                                                <table v-if="results.length != 0" class="table table-striped"
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in results" :key="'item' + index">
                                                            ...
                                                            <td><input type="number" min="0"
                                                                    v-model="item.sale_price" class="form-control"
                                                                    placeholder="Sale price"></td>
                                                            <td><button v-on:click="selectItem(index)"
                                                ...
                                                <table v-if="items.length != 0" class="table table-striped"
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(item, index) in items" :key="'selected_item' + index">
                                                            ...
                                                            <td><button v-on:click="removeItem(index)"
