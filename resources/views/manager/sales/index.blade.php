                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" id="cash-mode-form" action="{{ route('sales.set.cash', $sale->id) }}">
                                                        ...
                                                        <label class="form-check">
                                                            <input id="creditCheck" v-model="cash_mode" class="form-check-input" type="radio" value="0" name="cash_mode">
                                                        ...
                                                        <label class="form-check pb-3">
                                                            <input v-model="cash_mode" id="cashCheck" class="form-check-input" type="radio" value="1" name="cash_mode">
                                                            <span class="form-check-label">
                                                        ...
                                                        @enderror
                                                        <div id="cashIn" class="mt-3 lead" v-if="cash_mode == 1">
